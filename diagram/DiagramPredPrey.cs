...
public class DiagramPredPrey
    {
        ...
        public DiagramPredPrey(double alpha, double beta, double epsilon, double omega,
        ...
        public LineSeries<ObservablePoint>[] PhasePoints { get; set; }
